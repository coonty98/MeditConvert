...
Function Set-ToothNumber{
	...
	Return $USToothNumber, $ExObj_marginline, $TeethNode_v1021, $TeethNode_v222324, $TeethNode_v50
}
...
ForEach($subfolder in Get-ChildItem -LiteralPath $global:MfgrDir"Medit Convert" -Directory){
	...
	$USToothNumber, $ExObj_marginline, $TeethNode_v1021, $TeethNode_v222324, $TeethNode_v50 = Set-ToothNumber -casefolderpath: $foldername
    ...
    $xmlv10, $xmlv21, $xmlv22, $xmlv23, $xmlv24, $xmlv50 = New-XMLfiles -ptname: "$extractedname" -TeethNode_v1021: $TeethNode_v1021 -TeethNode_v222324: $TeethNode_v222324 -TeethNode_v50: $TeethNode_v50 -ExObj_lowerjaw: $ExObj_lowerjaw -ExObj_upperjaw: $ExObj_upperjaw -ExObj_lowerpreop: $ExObj_lowerpreop -ExObj_upperpreop: $ExObj_upperpreop -ExObj_lowerpreop_v2450: $ExObj_lowerpreop_v2450 -ExObj_upperpreop_v2450: $ExObj_upperpreop_v2450 -ExObj_marginline: $ExObj_marginline
    New-Item -Path $global:MfgrDir"Medit Convert\$foldername\iTero_Export_#999999999_v10.xml" -ItemType File -Value $xmlv10 | Out-Null
    New-Item -Path $global:MfgrDir"Medit Convert\$foldername\iTero_Export_#999999999_v21.xml" -ItemType File -Value $xmlv21 | Out-Null
    New-Item -Path $global:MfgrDir"Medit Convert\$foldername\iTero_Export_#999999999_v22.xml" -ItemType File -Value $xmlv22 | Out-Null
    New-Item -Path $global:MfgrDir"Medit Convert\$foldername\iTero_Export_#999999999_v23.xml" -ItemType File -Value $xmlv23 | Out-Null
    ...
    New-Item -Path $global:MfgrDir"Medit Convert\$foldername\iTero_Export_#999999999_v50.xml" -ItemType File -Value $xmlv50 | Out-Null
}
}
...
Function New-XMLfiles{
    ...
    param([string]$ptname,
          [string]$TeethNode_v1021,
		  [string]$TeethNode_v222324,
		  [string]$TeethNode_v50,
...
<iTeroExport Version="5.0">
	<RxInfo>
		...
		<LabTechnician/>
		<Patient>$ptname</Patient>
		<UniquePatientIdentifier>3bb83d53-65ef-43b0-a383-762a7293b0d2</UniquePatientIdentifier>
		<ChartNumber/>
		<Doctor>Null</Doctor>
		<DoctorLicense>Null</DoctorLicense>
		<DoctorID>Null</DoctorID>
		...
		<ProcedureType>0</ProcedureType>
		<Denture>
			<DentureShadeSystem>-1</DentureShadeSystem>
			<DentureTeethShade/>
			<DentureGingivalShade/>
			<DentureMould/>
			<DentureStage/>
			<UpperJaw>False</UpperJaw>
			<LowerJaw>False</LowerJaw>
			<DentureCopyScan>False</DentureCopyScan>
		</Denture>
		<TreatmentStage>0</TreatmentStage>
		<TeethBuccalTransforms/>
		<Bridges/>
		<Notes>Null</Notes>
		<Local_iDE ProductionCenterID="-1"/>
		<iDE_Order ProductionCenterID="0" CADCAMSystemTypeID="-1" SelectedProductionCenterName="" SelectedCadcamSystemName=""/>
		<CA_Order ProductionCenterID="0" SelectedProductionCenterName=""/>
		<DoctorCompanyID>112714</DoctorCompanyID>
	</RxInfo>
	<RxDefines>
		<RestorationTypes>
			<Type Id="2" Name="Crown"/>
		...
		<Procedure>
			<Type Id="4" Name="Fixed Restorative"/>
		</Procedure>
		<ProcedureType/>
		<Specification>
			<Type Id="1" Name="Full Contour"/>
		</Specification>
		<ImplantBasedRestoration/>
		<AbutmentType/>
		<PonticDesign/>
		<DentureShadeSystem>
...
"@
    ...
    Return $xmlv10, $xmlv21, $xmlv22, $xmlv23, $xmlv24, $xmlv50
}
